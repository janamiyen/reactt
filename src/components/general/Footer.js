...
const Footer = () => {
  return (
    ...
    <div class="web-map">
        <ul>
            <li class="big-link">LOCALES MÁS CERCANOS</li>
            <li class="big-link">REGISTRATE PARA RECIBIR NOVEDADES</li>
        </ul>
        <ul>
            <li class="big-link">ACERCA DE BURGERLAND </li>
            <li class="small-link">Noticias</li>
            <li class="small-link">Empleo</li>
            <li class="small-link">Inversores</li>
            <li class="small-link">Sustentabilidad</li>
        </ul>
    </div>
